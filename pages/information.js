    ...
    <PageContainer>
      ...
      <div className="flex flex-col gap-7 sm:gap-9">
        ...
        <p>
          ...
          Angeles Book Market (2024). His work has been featured in duo and
          group exhibitions at Ruth Gallery in Pasadena (2023, 2024). He
          presented the site specific work{" "}

const REFERENCES = [
  ...
  },
  {
    ...
    publisher: "semiotext(e)",
    pageNumber: "p. 140",
    quote: "Poetry is the language of nonexchangeability, the return of infinite hermeneutics, and the return of the sensuous boddy of language. I'm talking about poetry here as an excess of language, a hidden resource which enables us to shift from one paradigm to another."
  },
  {
    type: "quote",
    authorLast: "Vilém",

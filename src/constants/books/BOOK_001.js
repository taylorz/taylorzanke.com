...
const images = importAll(require.context('../../../src/assets/work-images/books/001', false, /\.(png|jpe?g|svg)$/));
...
const BOOK_001 = {
  ...
  pagesCount: 42,
  textStock: 'Classic Crest',
  coverStock: 'Card',
  productionInfo: 'Laser printed, cold glue and tape bound spine',
  edition: '1',
  images: [ images ],
  route: '/001'
}

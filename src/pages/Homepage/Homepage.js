...
const Homepage = () => (
  <PageContainer className="homepage-container">
    <Grid container spacing={4} className="section top-bar">
    ...
    <Grid container spacing={4} className="section summary dashed">
      <Grid item xs={6} sm={4}>
        Introduction
      </Grid>
    ...
    <Grid container spacing={4} className="section education double">
      <Grid item xs={12} sm={4}>
        Education
      </Grid>
      <Grid item xs={12} sm={8}>

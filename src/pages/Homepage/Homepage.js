...
import TwoCitiesReader2 from '../../assets/images/5a.png';
        ...
        <PageContainer className="homepage">
          ...
          <Grid container className="fragments" justify="space-between">
            <Grid item md={4} xs={12} className="fragment-container">
              <Fragment fragmentImage={TwoCitiesReader2} title="Two Cities Reader" year="2014"/>
            </Grid>
          ...
          <Whole workImage={TwoCitiesReader1}/>
        </PageContainer>
      </>
    );
  }

...
export async function getResume() {
  return await sanityClient.fetch(resumeQueries.single);
}

export async function getStatement() {
  return await sanityClient.fetch(statementQueries.single);
}

export async function getBiography() {
  return await sanityClient.fetch(biographyQueries.single);
}

export async function getExhibitions() {
  return await sanityClient.fetch(exhibitionQueries.list);
}

export async function getExhibition(slug) {
  return await sanityClient.fetch(exhibitionQueries.single, { slug });
}

export async function getIndividuals() {
  return await sanityClient.fetch(individualQueries.single);
}

export async function getBooks() {
  return await sanityClient.fetch(bookQueries.list);
}

export async function getBook(slug) {
  return await sanityClient.fetch(bookQueries.single, { slug });
}

export async function getWorkItem(slug) {
  return await sanityClient.fetch(workItemQueries.single, { slug });
}
